...
# Application
This project builds an integration script to run rating code of Hyip Project. The following diagram shows the different components and their interactions across environments. Read more detail and the tutorial [*here*](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/create_deploy_docker_ecstutorial.html).<br />
